...
class TestSamples(unittest.TestCase):
    ...
    def test_sample_a3(self):
        samplespec = self.samplespecs['A3']
        samplespec.save_samples()
        # check directory structure
        metadata_path = self.sample_dir / 'a3' / 'metadata.json'
        journal_path = self.sample_dir / 'a3' / 'journal.json'
        sample_path = self.sample_dir / 'a3' / '000' / '000.pth'
        self.assertTrue(os.path.isfile(metadata_path))
        self.assertTrue(os.path.isfile(journal_path))
        self.assertTrue(os.path.isfile(sample_path))
